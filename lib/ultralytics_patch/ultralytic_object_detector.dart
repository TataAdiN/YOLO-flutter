...
import 'package:yolo_flutter/ultralytics_patch/ultralytic_predictor.dart';

/// A predictor for object detection.
class UltralyticObjectDetector extends Predictor {
  /// Constructor to create an instance of [ObjectDetector].
  UltralyticObjectDetector({required YoloModel model}) : super(model);
