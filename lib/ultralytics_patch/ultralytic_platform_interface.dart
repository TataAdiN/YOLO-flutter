...
import 'package:yolo_flutter/ultralytics_patch/ultralytic_platform_channel.dart';

/// The interface that implementations of ultralytics_yolo must implement.
abstract class UltralyticPlatformInterface extends PlatformInterface {
  /// Constructs a UltralyticsYoloPlatform.
  UltralyticPlatformInterface() : super(token: _token);

  static final Object _token = Object();

  static UltralyticPlatformInterface _instance = UltralyticPlatformChannel();

  /// The default instance of [UltralyticsYoloPlatform] to use.
  ///
  /// Defaults to [PlatformChannelUltralyticsYolo].
  static UltralyticPlatformInterface get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [UltralyticsYoloPlatform] when
  /// they register themselves.
  static set instance(UltralyticPlatformInterface instance) {
